...
alias sshtum='ssh nedkov@lxhalle.informatik.tu-muenchen.de'
alias mypubip='curl icanhazip.com'
alias myprivips=$'/sbin/ifconfig | awk \'/inet addr/ { print substr($2,6) }\' | awk \'{ if (NR == 1) print "eth0", $1; else print "wlan0", $1 }\''
